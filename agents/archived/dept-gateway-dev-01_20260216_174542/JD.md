...
## 权限边界
### 允许
- 在 `/home/user/nexus-ai-team/agents/dept-gateway-dev-01/WORKSPACE/` 下创建、编辑、删除文件
...
### 禁止
- 查看 `/home/user/nexus-ai-team/agents/dept-gateway-dev-01/WORKSPACE/` 以外的任何文件或目录
